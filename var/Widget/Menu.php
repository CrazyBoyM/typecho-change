...
class Widget_Menu extends Typecho_Widget
{
    ...
    {
        $parentNodes = array(NULL, _t('资料'), _t('撰写'), _t('管理'), _t('设置'));
        ...
        array(
            array(_t('撰写作品'), _t('撰写新作品'), 'write-post.php', 'contributor'),
        ...
        array(
            array(_t('作品'), _t('管理作品'), 'manage-posts.php', 'contributor', false, 'write-post.php'),
