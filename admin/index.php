...
<head>
	<meta charset="UTF-8">
	<title><?php _e('个人中心 - %s', $options->title); ?></title>
...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="/">个人中心</a></div>
        <div class="left_open">
    ...
    <div class="page-content">
        <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
          ...
          <ul class="layui-tab-title">
            <li class="home"><i class="layui-icon">&#xe68e;</i>西窗烛</li>
          </ul>
          <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='//lib.xcz.im/nav-poetry' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
          </div>
        </div>
    </div>
