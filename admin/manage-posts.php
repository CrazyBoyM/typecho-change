                        ...
                        <div class="operate">
                            ...
                            <div class="btn-group btn-drop">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a lang="<?php _e('你确认要删除这些作品吗?'); ?>" href="<?php $security->index('/action/contents-post-edit?do=delete'); ?>"><?php _e('删除'); ?></a></li>
                                </ul>
                            </div>  
                        </div>
                        <div class="search" role="search">
                            ...
                            <a href="<?php $options->adminUrl('manage-posts.php'
                                . (isset($request->status) || isset($request->uid) ? '?' .
                                    ...
                                    (isset($request->uid) ? '?uid=' . htmlspecialchars($request->get('uid')) : '') : '')); ?>"><?php _e('&laquo; 取消查找'); ?></a>
                            <?php endif; ?>
                            ...
                            <button type="submit" class="btn btn-s"><?php _e('查找'); ?></button>
                ...
                <div class="typecho-table-wrap">
                    <table class="typecho-list-table">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                            <tr>
                            	<td colspan="6"><h6 class="typecho-list-table-title"><?php _e('没有任何作品'); ?></h6></td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
